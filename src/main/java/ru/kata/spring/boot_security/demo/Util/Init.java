...
public class Init {
    ...
    public void initilazedDB() {
        ...
        userService.save(new User("renya", "krokodilov", "admin","admin", adminRole));
        userService.save(new User("poppy", "tank", "user","user", userRole));
        userService.save(new User("ez", "adc", "test","test", allRoles));
    }
}
